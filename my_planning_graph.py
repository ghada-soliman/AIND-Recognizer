...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if action_node.prenodes.issubset(self.s_levels[level]):
                a_nodes.append(action_node)
                for state_node in self.s_levels[level]:
                    state_node.children.add(action_node)
                    action_node.parents.add(state_node)
        self.a_levels.append(a_nodes) # adds A nodes to the current level in self.a_levels[level]
    ...
    def add_literal_level(self, level):
        ...
        for action_node in self.a_levels[level - 1]:
            for s_node in action_node.effnodes:
                s_nodes.add(s_node)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        node_a1_eff_add = set(node_a1.action.effect_add)
        node_a1_eff_rem = set(node_a1.action.effect_rem)

        node_a2_eff_add = set(node_a2.action.effect_add)
        node_a2_eff_rem = set(node_a2.action.effect_rem)
        
        return (node_a1_eff_add & node_a2_eff_rem) | (node_a1_eff_rem & node_a2_eff_add)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        node_a1_prec_pos = set(node_a1.action.precond_pos)
        node_a1_prec_neg = set(node_a1.action.precond_neg)
        
        node_a2_prec_pos = set(node_a2.action.precond_pos)
        node_a2_prec_neg = set(node_a2.action.precond_neg)
        
        return (node_a1_eff_add & node_a2_prec_neg) | (node_a1_eff_rem & node_a2_prec_pos) | (node_a2_eff_add & node_a1_prec_neg) | (node_a2_eff_rem & node_a1_prec_pos)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for node_a1_parent in node_a1.parents:
            for node_a2_parent in node_a2.parents:
                return node_a1_parent.is_mutex(node_a2_parent)
        return False
    ...
    def h_levelsum(self) -> int:
        ...
        # Reference: https://discussions.udacity.com/t/error-while-running-unittest-tests-test-my-planning-graph/252987/26
